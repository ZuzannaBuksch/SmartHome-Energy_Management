...
class TestEnergy:
    ...
    def test_calculate_energy_usage_for_1_hour(self, mock_measurements, home_setup):
    ...
    def test_calculate_energy_usage_for_1_hour_with_storage(self, mock_raports, mock_storage, mock_measurements, home_setup):
    ...
    @patch('smarthome.measurements_manager.EnergyMeasurementsManager._get_storage_measurements')
    @patch('smarthome.measurements_manager.EnergyMeasurementsManager._get_storage_raports')
    def test_calculate_energy_usage_for_1_hour_with_storage_and_exchange(self, mock_raports, mock_storage, mock_measurements,mock_pricer, home_setup):
    ...
    @patch('smarthome.measurements_manager.EnergyMeasurementsManager._get_storage_measurements')
    @patch('smarthome.measurements_manager.EnergyMeasurementsManager._get_storage_raports')
    def test_calculate_energy_usage_for_2_hour_with_storage_and_exchange_with_windows(self, mock_raports, mock_storage, mock_measurements,mock_pricer, home_setup):
    ...
    @patch('smarthome.measurements_manager.EnergyMeasurementsManager._get_storage_measurements')
    @patch('smarthome.measurements_manager.EnergyMeasurementsManager._get_storage_raports')
    def test_calculate_energy_usage_for_2_hour_with_storage_and_energy_exchange_in_first_window(self, mock_raports, mock_storage, mock_measurements,mock_pricer, home_setup):
        """Check energy usage calculations in home with storage and energy exchange in double time window (2*59 minutes)"""
        db = self.setUpBuildingSinglePhotovoltaics()
        building = db["building"]
        receiver = db["devices"][0]
    ...
    @patch('smarthome.measurements_manager.EnergyMeasurementsManager._get_storage_measurements')
    @patch('smarthome.measurements_manager.EnergyMeasurementsManager._get_storage_raports')
    def test_calculate_energy_usage_for_2_hour_with_storage_and_energy_exchange_in_second_window(self, mock_raports, mock_storage, mock_measurements,mock_pricer, home_setup):
        """Check energy usage calculations in home with storage and energy exchange in double time window (2*59 minutes)"""
        db = self.setUpBuildingSinglePhotovoltaics()
        building = db["building"]
        receiver = db["devices"][0]
    ...
    @patch('smarthome.measurements_manager.EnergyMeasurementsManager._get_storage_measurements')
    @patch('smarthome.measurements_manager.EnergyMeasurementsManager._get_storage_raports')
    def test_calculate_energy_usage_for_1_hour_photovoltaics_and_storage_with_windows(self, mock_raports, mock_storage, mock_measurements,mock_pricer, home_setup):
        """Check energy usage calculations in home with storage and energy exchange in double time window (2*59 minutes)"""
        db = self.setUpBuildingSinglePhotovoltaics()
        building = db["building"]
        receiver = db["devices"][0]
    ...
    @patch('smarthome.price_manager.PriceManager.get_price_by_source')
    @patch('smarthome.measurements_manager.EnergyMeasurementsManager._get_energy_measurements')
    def test_calculate_energy_usage_for_1_hour_photovoltaics_with_windows(self, mock_measurements,mock_pricer, home_setup):
        """Check energy usage calculations in home with storage and energy exchange in double time window (2*59 minutes)"""
        db = self.setUpBuildingSinglePhotovoltaics()
        building = db["building"]
        receiver = db["devices"][0]
