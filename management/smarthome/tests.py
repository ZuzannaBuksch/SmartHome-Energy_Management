...
class EnergyTestCase(TestCase):
    ...
    def setUpSingleHRD(self):
        ...
        user = User.objects.create(
            id=0, email="usereczek@email.com", password="testusereczek123"
        )
        ...
        return EnergyReceiver.objects.create(
            id=0, room=room, name="bulb", state=False, energy_consumption=50
        )
    ...
    def setUpSingleHRManyD(self):
        ...
        user = User.objects.create(
            id=10, email="usereczek2@email.com", password="testusereczek123"
        )
        ...
        EnergyReceiver.objects.create(
            id=10, room=room, name="bulb1", state=False, energy_consumption=50
        )
        EnergyReceiver.objects.create(
            id=11, room=room, name="bulb2", state=False, energy_consumption=50
        )
        return EnergyReceiver.objects.create(
            id=12, room=room, name="bulb3", state=False, energy_consumption=50
        )
