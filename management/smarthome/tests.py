...
class EnergyTestCase(TestCase):
    ...
    #         photovoltaics_data = source_raport.energy_sources[sources.PHOTOVOLTAICS]
    ...
    #         self.assertEqual(photovoltaics_data["price"],0)
    #         public_grid_data = source_raport.energy_sources[sources.PUBLIC_GRID]
    ...
    def test_calculate_photovoltaics_and_grid_surplus_are_enough(self):
        ...
        with patch.object(BuildingEnergyManager, '_download_energy_data_task_tmp', return_value=measurements):
            ...
            grid_surplus_data = source_raport.energy_sources[sources.GRID_SURPLUS]
